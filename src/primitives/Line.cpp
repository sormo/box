...
namespace primitive
{
		...
		: Primitive(type)
	{
		...
		m_left = new primitive::Line({ 0.0f, 0.0f }, rotate(oxygine::Vector2{ ARROW_LENGHT, 0.0f }, fromDegToRad(150.0f)), m_drawType);
		m_right = new primitive::Line({ 0.0f, 0.0f }, rotate(oxygine::Vector2{ ARROW_LENGHT, 0.0f }, fromDegToRad(210.0f)), m_drawType);
		addChild(m_left);
		addChild(m_right);
